...
def build_1(l):
    l = keras.layers.Conv2D(64, kernel_size=(4, 8), padding='valid', input_shape=[4, 1500, 1])(l)
    ...
    l = keras.layers.Bidirectional(keras.layers.LSTM(64, return_sequences=True))(l)
    return l
